...
const event1: Evento = {
  ...
  category: { description: 'Conciertos', urlImage: 'https://aeronoticias.com.pe/noticiero/wp-content/uploads/2022/10/apla.jpg' },
  venue: venue2
}
...
const event3: Evento = {
  ...
  category: { description: 'Deportes', urlImage: 'https://media.tycsports.com/files/2022/03/02/396970/river-pibes_862x485.jpg' },
  venue: venue3
}
...
const event4: Evento = {
  ...
  description: 'Género de danza que se basa en la interpretación y visión individual del bailarín o coreógrafo.',
  category: { description: 'Teatros', urlImage: 'https://www.sanangel.edu.mx/sites/default/files/gdi/OBRA%20DE%20TEATRO.jpg' },
  venue: venue4
}
