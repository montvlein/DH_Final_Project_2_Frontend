    ...
    return (
        <>
            <div className="flex flex-col lg:flex-row bg-white pt-3 pl-4">
                ...
                <div className="lg:w-3/5 p-4 flex justify-center">
                    ...
                    <div>
                        ...
                        <p className='font-montserrat text-base font-normal leading-7 tracking-tighter text-left'>
                            1. Tu/s ticket/s serán smart tickets que tendrás disponibles en la App de Quentro a partir del 10 de Octubre. Recibirás las instrucciones por mail para descargarte la App en tu celular y obtener los Smart tickets.
                        </p>
                        <p className='font-montserrat text-base font-normal leading-7 tracking-tighter text-left'>
                ...
                <div className="w-full lg:w-1/3 pt-7 pr-4">
                    {/* POLITICA DE MENORES */}
                    <div className="mx-6">
