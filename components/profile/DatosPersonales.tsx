    ...
    <section className="flex flex-col z-10 w-11/12">
      ...
      <div className="shadow-lg bg-white dark:bg-gray-700 dark:text-white">
        <div className="flex gap-2 justify-around">
          ...
          <Link href={userData.id + '/password/'}><button className="grow py-4 uppercase font-semibold lg:text-2xl text-xs  ">Cambiar contraseña</button></Link>
          <Link href={userData.id + '/tickets/' }><button className="grow py-4 uppercase font-semibold lg:text-2xl text-xs  ">Mis entradas</button></Link>
        </div>
        <form className="p-8">
