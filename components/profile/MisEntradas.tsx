        ...
        <div className="p-8 flex flex-col gap-4">
          { loading
            ? <div className='h-[50vh] relative'>
              <div role="status" className='absolute inset-0 bg-transparent backdrop-blur-sm brightness-50 z-40 flex items-center justify-center rounded-lg'>
                <svg aria-hidden="true" className="inline w-10 h-10 text-gray-800 animate-spin fill-rose-300" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
